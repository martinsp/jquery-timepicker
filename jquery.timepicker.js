	...
	var methods = {
		...
		show: function(e)
		{
			...
			if (selected && selected.length) {
				var topOffset = scrollList.scrollTop() + selected.position().top - selected.outerHeight();
			...
			if(settings.stopScrollPropagation) {
				$(document).on('wheel.ui-timepicker', '.ui-timepicker-wrapper [data-container="timepicker-list"]', function(e){
					e.preventDefault();
